...
<head>
  ...
  <title>ZIVR Privacy Policy</title>
  <style>
...
<body>
  <div class="container">
    <h1>ZIVR Privacy Policy</h1>
    <p class="updated">Last updated: March 2026</p>

    <div class="section">
      <h2>1. Information We Collect</h2>
      <p>ZIVR collects the following information to provide its services:</p>
      <ul>
        ...
        <li><strong>Contacts:</strong> With your permission, we access your device contacts to help you find friends who use ZIVR. We do not store your full contact list on our servers.</li>
    ...
    <div class="section">
      ...
      <ul>
        ...
        <li><strong>Contacts:</strong> Used to find friends on ZIVR and invite others. Not stored on our servers.</li>
    ...
    <div class="section">
      ...
      <p>ZIVR offers ZivCoin, a virtual currency purchasable through Apple App Store and Google Play in-app purchase systems. Purchases are processed by Apple or Google according to their respective terms. ZIVR does not store your payment information.</p>
    </div>

    <div class="section">
      <h2>6. Children's Privacy</h2>
      <p>ZIVR is not intended for users under the age of 13. We do not knowingly collect information from children under 13. If you believe a child has provided us with personal information, please contact us.</p>
    </div>
    ...
    <div class="section">
      <h2>9. Contact Us</h2>
      <p>If you have questions about this privacy policy or your data, contact us at: <a href="mailto:privacy@zivr.app">privacy@zivr.app</a></p>
    </div>
  </div>
</body>
</html>`);
...
<body>
  <div class="container">
    ...
    <div class="card">
      ...
      <p>Email us at <a href="mailto:support@zivr.app">support@zivr.app</a> and we'll get back to you within 24 hours.</p>
    </div>
    <div class="card">
      ...
      <p><strong>How do I delete my account?</strong><br>Email us at support@zivr.app with subject "Delete Account" and your username.</p>
    </div>
  </div>
</body>
</html>`);
