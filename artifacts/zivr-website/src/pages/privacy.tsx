    ...
    <div className="min-h-screen bg-paper-2">
      ...
      <header className="bg-ink text-paper-2 py-16 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-slate-light text-lg">Last updated: August 2026</p>
        </div>
      </header>
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 space-y-14">
        ...
        <section>
          ...
          <div className="space-y-6 text-slate leading-relaxed">
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Account information</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Child and parent accounts</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Server messages</h3>
              <p>
                ...
                <strong className="text-ink">Messages are retained indefinitely</strong> — there
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Local chat backups</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Contacts and groups</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Call history</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Device contacts</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Device push tokens</h3>
              <p>
            ...
            <div>
              <h3 className="text-lg font-semibold text-ink mb-2">Usage and diagnostics</h3>
              <p>
        ...
        <section>
          ...
          <div className="space-y-4 text-slate leading-relaxed">
            ...
            <p className="text-sm bg-paper rounded-xl p-4 text-slate-light">
              <strong className="text-ink">Third-party AI:</strong> Message text from chats
        ...
        <section>
          ...
          <div className="space-y-5 text-slate leading-relaxed">
            ...
            <div className="bg-paper rounded-xl p-5 space-y-3">
              <h3 className="text-base font-semibold text-ink">Chat Passcode (access lock)</h3>
              <p>
            ...
            <div className="bg-paper rounded-xl p-5 space-y-3">
              <h3 className="text-base font-semibold text-ink">Per-chat Encryption (message content)</h3>
              <p>
              ...
              <p className="text-sm text-slate-light">
                <strong className="text-ink">What this does not do:</strong> this encryption
        ...
        <section>
          ...
          <div className="space-y-4 text-slate leading-relaxed">
            ...
            <p>
              <strong className="text-ink">Limitations:</strong> screenshot protection relies
        ...
        <section>
          <div className="flex items-center gap-3 mb-5">
            <div className="w-10 h-10 rounded-xl bg-paper0/10 flex items-center justify-center shrink-0">
              <Shield className="w-5 h-5 text-slate-light" />
            </div>
          ...
          <div className="space-y-4 text-slate leading-relaxed">
            ...
            <ul className="list-disc list-inside space-y-2 ml-2">
              <li>
                <strong className="text-ink">Anthropic (content safety)</strong> — message
              ...
              <li>
                <strong className="text-ink">Anthropic (PDF export appendix)</strong> — if
              ...
              <li>
                <strong className="text-ink">Infrastructure providers</strong> — cloud hosting,
        ...
        <section>
          ...
          <div className="space-y-4 text-slate leading-relaxed">
            ...
            <p className="text-sm text-slate-light bg-paper rounded-xl p-4">
        ...
        {/* 10. Contact */}
        <section className="bg-paper rounded-2xl p-8">
          ...
          <p className="text-slate mb-4 leading-relaxed">
            ...
            our{' '}
            <Link href="/support" className="text-coral underline underline-offset-2 hover:text-coral/80 transition-colors">
              support page
            </Link>{' '}
      ...
      <footer className="border-t border-border py-8 px-6 text-center text-sm text-slate-light">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-6">
            <Link href="/privacy" className="hover:text-ink transition-colors font-medium text-coral">Privacy</Link>
